...
public enum STType
   ...
   * </pre>
   *
   * <code>CHAT_TYPE_HEARTBEAT = 4;</code>
   */
  CHAT_TYPE_HEARTBEAT(4),
  /**
   * <pre>
   * 心跳响应
   * </pre>
   *
   * <code>CHAT_TYPE_HEARTBEAT_RESPONSE = 5;</code>
   */
  CHAT_TYPE_HEARTBEAT_RESPONSE(5),
  UNRECOGNIZED(-1),
  ;
   ...
   * <code>CHAT_TYPE_HEARTBEAT = 4;</code>
   */
  public static final int CHAT_TYPE_HEARTBEAT_VALUE = 4;
  /**
   * <pre>
   * 心跳响应
   * </pre>
   ...
   * <code>CHAT_TYPE_HEARTBEAT_RESPONSE = 5;</code>
   */
  public static final int CHAT_TYPE_HEARTBEAT_RESPONSE_VALUE = 5;
  ...
  public static STType forNumber(int value) {
    switch (value) {
      ...
      case 4: return CHAT_TYPE_HEARTBEAT;
      case 5: return CHAT_TYPE_HEARTBEAT_RESPONSE;
      default: return null;
    }
  }
